  ...
  return (
    <div>
        ...
        <div className = '/question-text'>
          Hello, Claire will support you with assistance Level {level}，with {assistance} explanations. You will receive detailed explanations 
          about the car's actions on the dashboard and basic explanations through audio announcement. Additionally, Claire will ask you to take control 
